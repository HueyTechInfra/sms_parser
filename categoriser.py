...
def categoriser(data):
    for x in range(len(data)):
        ...
        # finding otp msgs
            ...
            if re.search(msg, regex_otp1, re.IGNORECASE):
        ...
        elif re.search(regex_auto_debit, msg, re.IGNORECASE):
            primary_type.append("info")
        ...
        if re.search(regex_sender, sender, re.IGNORECASE):
            ...
            category.append("others")
    new_df = pd.DataFrame(
        {'Message': str_temp, 'Account Number': account_no, 'Transaction ID': transaction_id, "Amount": amount,
